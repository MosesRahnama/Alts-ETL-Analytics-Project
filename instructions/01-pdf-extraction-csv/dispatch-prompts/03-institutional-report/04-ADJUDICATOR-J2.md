# Institutional Report: ADJUDICATOR J2
...
```powershell
python instructions/01-pdf-extraction-csv/workflow.py claim --route 03-institutional-report --agent J2 --model "<model name>"
```
