# Statements and Economics: ADJUDICATOR J2
...
```powershell
python instructions/01-pdf-extraction-csv/workflow.py claim --route 06-statements-and-economics --agent J2 --model "<model name>"
```
