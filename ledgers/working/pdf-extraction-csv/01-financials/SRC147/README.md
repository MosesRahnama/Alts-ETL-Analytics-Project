...
Independent extraction records, page coverage, and review outputs for SRC147.

| File | Role |
|---|---|
| `records-a.csv` | Extractor A source records. Header-only: coverage-final.csv records the reviewed page statuses. |
| `records-b.csv` | Extractor B source records. Header-only: coverage-final.csv records the reviewed page statuses. |
| `coverage-a.csv` | Physical pages reviewed by Extractor A. |
| `coverage-b.csv` | Physical pages reviewed by Extractor B. |
| `pair-index.csv` | Paired agreements, disagreements, and one-sided candidate rows. Header-only: coverage-final.csv records the reviewed page statuses. |
