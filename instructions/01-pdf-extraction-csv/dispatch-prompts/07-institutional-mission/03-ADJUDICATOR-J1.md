...
```powershell
python instructions/01-pdf-extraction-csv/workflow.py repair-shifted --route 07-institutional-mission --file <file_id> --agent A
python instructions/01-pdf-extraction-csv/workflow.py repair-shifted --route 07-institutional-mission --file <file_id> --agent B
python instructions/01-pdf-extraction-csv/workflow.py repair-value-format --route 07-institutional-mission --file <file_id> --agent A
python instructions/01-pdf-extraction-csv/workflow.py repair-value-format --route 07-institutional-mission --file <file_id> --agent B
