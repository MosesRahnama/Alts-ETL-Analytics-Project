    ...
    def setUp(self) -> None:
        ...
        self._originals = {
            ...
            for name in (
                ...
                "WORKSHEET_DIR",
                "NEAR_DUPLICATES",
                # setUp rebinds these two as well. Leaving them out left the
                # module pointing at a deleted temporary directory for the rest
                # of the run, and the release stages that declare
                # `name_normalization.KINDS` then declared ten files that no
                # longer exist.
                "KINDS",
                "MATRIX_HEADER",
            )
