# Institutional Mission: EXTRACTOR B
...
- **Record output:** `ledgers/working/pdf-extraction-csv/07-institutional-mission/<file_id>/records-b.csv`
- **Coverage output:** `ledgers/working/pdf-extraction-csv/07-institutional-mission/<file_id>/coverage-b.csv`
...
```powershell
python instructions/01-pdf-extraction-csv/workflow.py lane-check --route 07-institutional-mission --agent B
```
...
```powershell
python instructions/01-pdf-extraction-csv/workflow.py claim --route 07-institutional-mission --agent B --model "<model name>"
```
...
```powershell
python instructions/01-pdf-extraction-csv/workflow.py validate-candidate --route 07-institutional-mission --file <file_id> --agent B
```
...
```powershell
python instructions/01-pdf-extraction-csv/workflow.py validate-candidate --route 07-institutional-mission --file <file_id> --agent B --through-page 3
```
...
```powershell
python instructions/01-pdf-extraction-csv/workflow.py audit-file --route 07-institutional-mission --file <file_id> --agent B
```
