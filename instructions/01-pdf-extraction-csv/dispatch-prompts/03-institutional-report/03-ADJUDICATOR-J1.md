...
```powershell
python instructions/01-pdf-extraction-csv/workflow.py repair-shifted --route 03-institutional-report --file <file_id> --agent A
python instructions/01-pdf-extraction-csv/workflow.py repair-shifted --route 03-institutional-report --file <file_id> --agent B
python instructions/01-pdf-extraction-csv/workflow.py repair-value-format --route 03-institutional-report --file <file_id> --agent A
python instructions/01-pdf-extraction-csv/workflow.py repair-value-format --route 03-institutional-report --file <file_id> --agent B
...
| `Institutional_Report` | `CORE` | `fund_economics_observation` | one populated allowed source value cell | `commitment`, `paid_in_capital`, `contribution`, `distribution`, `nav`, `unfunded_commitment`, `recallable_distribution`, `tvpi`, `dpi`, `rvpi`, `moic`, `ownership_percentage`, `income`, `fee`, `carried_interest` |
