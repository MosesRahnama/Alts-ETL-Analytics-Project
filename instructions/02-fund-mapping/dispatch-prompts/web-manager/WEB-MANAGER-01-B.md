# Web manager B: slice 01

*Generated by `name_normalization dispatch` from `03-WEB-MANAGER-B.md` and `manager-01-b.csv`. Regenerate this file; do not hand-edit it. Do not delete it when the slice is settled.*

- **Project root:** the repository root, the folder holding `README.md`; every path below is relative to it
- **Worksheet:** `data/normalization/worksheets/manager-01-b.csv`
