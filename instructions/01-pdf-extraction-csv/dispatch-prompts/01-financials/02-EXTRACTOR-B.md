...
- **Record output:** `ledgers/working/pdf-extraction-csv/01-financials/<file_id>/records-b.csv`
- **Coverage output:** `ledgers/working/pdf-extraction-csv/01-financials/<file_id>/coverage-b.csv`
...
```powershell
python instructions/01-pdf-extraction-csv/workflow.py claim --route 01-financials --agent B --model "<model name>"
```
...
```powershell
python instructions/01-pdf-extraction-csv/workflow.py validate-candidate --route 01-financials --file <file_id> --agent B --through-page 1
```
