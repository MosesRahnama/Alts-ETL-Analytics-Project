# Name normalizer: slice 01

*Generated by `name_normalization dispatch` from `01-NAME-NORMALIZER.md` and `fund-part-01.csv`. Regenerate this file; do not hand-edit it. Do not delete it when the slice is settled.*

- **Project root:** the repository root, the folder holding `README.md`; every path below is relative to it
- **Worksheet:** `data/normalization/worksheets/fund-part-01.csv`
