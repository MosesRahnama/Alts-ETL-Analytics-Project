# Statements and Economics: ADJUDICATOR J1
...
- **Shard:** worklist rows with odd `work_order` values.
...
```powershell
python instructions/01-pdf-extraction-csv/workflow.py claim --route 06-statements-and-economics --agent J1 --model "<model name>"
```
...
```powershell
python instructions/01-pdf-extraction-csv/workflow.py compare --route 06-statements-and-economics --file <file_id>
```
...
```powershell
python instructions/01-pdf-extraction-csv/workflow.py build-final --route 06-statements-and-economics --file <file_id>
python instructions/01-pdf-extraction-csv/workflow.py validate-final --route 06-statements-and-economics --file <file_id>
```
