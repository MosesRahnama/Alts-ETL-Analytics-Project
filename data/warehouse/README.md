...
| File | Owner | Content |
|---|---|---|
| `extracted.duckdb` | `data/extracted/tables/`, `data/extracted/wide/` | 9 star tables with foreign keys, 18 wide tables, `bridge_pivot_observation`, 4 views (`sql/duckdb/03`, `04`); published source observations |
