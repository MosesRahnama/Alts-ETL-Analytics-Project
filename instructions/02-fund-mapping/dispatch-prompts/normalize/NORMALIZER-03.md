# Name normalizer: slice 03

*Generated by `name_normalization dispatch` from `01-NAME-NORMALIZER.md` and `fund-part-03.csv`. Regenerate this file; do not hand-edit it. Do not delete it when the slice is settled.*

- **Project root:** the repository root, the folder holding `README.md`; every path below is relative to it
- **Worksheet:** `data/normalization/worksheets/fund-part-03.csv`
- **Slice:** 120 printed fund names; 120 already finished in an earlier session. Every row is finished. This file stays: it is the standing brief for this slice.
