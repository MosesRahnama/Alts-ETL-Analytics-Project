...
FIXTURE_RULES = "fixture-parameters"
DEFECT_RATE = "mock-defect-rate"
...
QUALITY_INPUTS = tuple(matrices.resolve(FIXTURE_RULES, "quality_inputs").split("|"))
...
def score_detection(directory: Path) -> list[dict[str, str]]:
    ...
    if matrices.resolve(FIXTURE_RULES, "scorecard_source") != "defect_injections_vs_quality_results":
        raise PipelineError("fixture-parameters.csv names an unknown scorecard source")
...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--fund-count", type=int, default=int(matrices.resolve(FIXTURE_RULES, "default_fund_count")))
    parser.add_argument("--seed", type=int)
    parser.add_argument("--defect-rate", type=float, default=float(matrices.resolve(DEFECT_RATE, "default_defect_rate")))
    parser.add_argument("--benchmark-id", default=matrices.resolve(FIXTURE_RULES, "default_benchmark"))
    parser.add_argument("--portfolio-id", default=matrices.resolve(FIXTURE_RULES, "default_portfolio"))
    parser.add_argument("--portfolio-perspective", default="fund_total")
    parser.add_argument("--periodicity", default=matrices.resolve(FIXTURE_RULES, "default_periodicity"))
    parser.add_argument("--checked-at", default=matrices.resolve(FIXTURE_RULES, "default_checked_at"))
    parser.add_argument(
        "--database",
        type=Path,
