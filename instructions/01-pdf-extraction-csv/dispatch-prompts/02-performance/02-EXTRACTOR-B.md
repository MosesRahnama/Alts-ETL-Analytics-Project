...
- **Record output:** `ledgers/working/pdf-extraction-csv/02-performance/<file_id>/records-b.csv`
- **Coverage output:** `ledgers/working/pdf-extraction-csv/02-performance/<file_id>/coverage-b.csv`
...
```powershell
python instructions/01-pdf-extraction-csv/workflow.py claim --route 02-performance --agent B --model "<model name>"
```
...
```powershell
python instructions/01-pdf-extraction-csv/workflow.py validate-candidate --route 02-performance --file <file_id> --agent B --through-page 3
```
