...
| Published reports | `python data-gathering/src/render_image_corpus.py --published-slice` |
...
| `render-log.csv` | One row per render attempt with its output path and result. |
