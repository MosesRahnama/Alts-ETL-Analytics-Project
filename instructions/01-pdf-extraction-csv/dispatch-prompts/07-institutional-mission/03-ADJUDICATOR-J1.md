# Institutional Mission: ADJUDICATOR J1
...
```powershell
python instructions/01-pdf-extraction-csv/workflow.py claim --route 07-institutional-mission --agent J1 --model "<model name>"
```
...
```powershell
python instructions/01-pdf-extraction-csv/workflow.py compare --route 07-institutional-mission --file <file_id>
```
...
```powershell
python instructions/01-pdf-extraction-csv/workflow.py build-final --route 07-institutional-mission --file <file_id>
python instructions/01-pdf-extraction-csv/workflow.py validate-final --route 07-institutional-mission --file <file_id>
```
