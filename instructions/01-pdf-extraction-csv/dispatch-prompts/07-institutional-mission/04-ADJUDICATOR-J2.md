# Institutional Mission: ADJUDICATOR J2
...
```powershell
python instructions/01-pdf-extraction-csv/workflow.py claim --route 07-institutional-mission --agent J2 --model "<model name>"
```
