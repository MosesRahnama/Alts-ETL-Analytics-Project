# Institutional Report: EXTRACTOR A
...
- **Record output:** `ledgers/working/pdf-extraction-csv/03-institutional-report/<file_id>/records-a.csv`
- **Coverage output:** `ledgers/working/pdf-extraction-csv/03-institutional-report/<file_id>/coverage-a.csv`
...
```powershell
python instructions/01-pdf-extraction-csv/workflow.py claim --route 03-institutional-report --agent A --model "<model name>"
```
...
```powershell
python instructions/01-pdf-extraction-csv/workflow.py validate-candidate --route 03-institutional-report --file <file_id> --agent A --through-page 3
```
