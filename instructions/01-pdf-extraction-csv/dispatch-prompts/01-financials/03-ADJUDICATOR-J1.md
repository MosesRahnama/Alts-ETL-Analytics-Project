...
```powershell
python instructions/01-pdf-extraction-csv/workflow.py repair-shifted --route 01-financials --file <file_id> --agent A
python instructions/01-pdf-extraction-csv/workflow.py repair-shifted --route 01-financials --file <file_id> --agent B
python instructions/01-pdf-extraction-csv/workflow.py repair-value-format --route 01-financials --file <file_id> --agent A
python instructions/01-pdf-extraction-csv/workflow.py repair-value-format --route 01-financials --file <file_id> --agent B
...
```powershell
python instructions/01-pdf-extraction-csv/workflow.py claim --route 01-financials --agent J1 --model "<model name>"
```
