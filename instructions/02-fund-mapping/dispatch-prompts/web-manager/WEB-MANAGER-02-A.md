# Web manager A: slice 02

*Generated by `name_normalization dispatch` from `02-WEB-MANAGER-A.md` and `manager-02-a.csv`. Regenerate this file; do not hand-edit it. Do not delete it when the slice is settled.*

- **Project root:** the repository root, the folder holding `README.md`; every path below is relative to it
- **Worksheet:** `data/normalization/worksheets/manager-02-a.csv`
