# Fund Legal Documents: EXTRACTOR B
...
- **Record output:** `ledgers/working/pdf-extraction-csv/05-fund-legal-docs/<file_id>/records-b.csv`
- **Coverage output:** `ledgers/working/pdf-extraction-csv/05-fund-legal-docs/<file_id>/coverage-b.csv`
...
```powershell
python instructions/01-pdf-extraction-csv/workflow.py lane-check --route 05-fund-legal-docs --agent B
```
...
```powershell
python instructions/01-pdf-extraction-csv/workflow.py claim --route 05-fund-legal-docs --agent B --model "<model name>"
```
...
```powershell
python instructions/01-pdf-extraction-csv/workflow.py validate-candidate --route 05-fund-legal-docs --file <file_id> --agent B --through-page 3
```
...
```powershell
python instructions/01-pdf-extraction-csv/workflow.py audit-file --route 05-fund-legal-docs --file <file_id> --agent B
```
