...
| `test_promotion_matrices.py` | The promotion helpers return the matrix output, and a row's presence alone decides nothing. |
...
| `test_release_receipts.py` | The release receipt declares what each stage reads and what it writes. |
