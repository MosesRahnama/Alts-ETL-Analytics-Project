...
| `build_release_audit.py` | Generate the complete release table from stage descriptions and recorded checks. |
| `build_release_counts.py` | Write the one file every reviewer-facing count is read from. |
