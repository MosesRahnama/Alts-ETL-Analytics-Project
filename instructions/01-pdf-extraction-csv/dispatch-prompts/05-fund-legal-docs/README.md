# Route 05-fund-legal-docs briefs

Generated extractor and adjudicator briefs for route 05-fund-legal-docs, one file per role; rebuilt by build_csv_pipeline.
